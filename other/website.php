...
<!-- <div id="content" class="app-content"> -->
  ...
  <script type="template/mustache" id="server-template">
    <tr class="{{alert}}">
      <td rowspan="2" class="sertitle">
        <a class="wname" target="_blank">{{friendly_name}}</span>
		<br>
  ...
  <script src="https://cos.mbrjun.cn/assets/status/mustache.min.js" type="text/javascript"></script>
...
?>
  ...
  <script src="https://cos.mbrjun.cn/assets/status/cup.js" type="text/javascript"></script>
  <script type="text/javascript">
